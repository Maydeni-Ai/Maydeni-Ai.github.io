...
const TRANSLATIONS = {
  fr: {
    ...
    _delegates_starter:"Jusqu'à <strong>3</strong> agents terrain",_delegates_pro:"Jusqu'à <strong>10</strong> agents terrain",_delegates_enterprise:'<strong>11 et +</strong> agents terrain',
  ...
  en: {
    ...
    hero_download_app:'Download the App',hero_download_dash:'Download Dashboard',
    ...
    _delegates_starter:'Up to <strong>3</strong> field agents',_delegates_pro:'Up to <strong>10</strong> field agents',_delegates_enterprise:'<strong>11 and more</strong> field agents',
